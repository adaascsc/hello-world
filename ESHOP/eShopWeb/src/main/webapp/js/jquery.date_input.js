...
DateInput.prototype = {
  build: function() {
    ...
    var nav = $('<div class="nav" width="220px"></div>').append(monthNav, yearNav);
    
    var tableShell = '<div width="220px"><table><thead><tr>';
    $(this.adjustDays(this.short_day_names)).each(function() {
      tableShell += "<th>" + this + "</th>";
    });
    tableShell += "</tr></thead><tbody></tbody></table></div>";
    
    this.dateSelector = this.rootLayers = $('<div class="date_selector" width="220px"></div>').append(nav, tableShell).insertAfter(this.input);
    ...
    if ($.browser.msie && $.browser.version < 7) {
      ...
      this.ieframe = $('<iframe width="220px" class="date_selector_ieframe" frameborder="0" src="#"></iframe>').insertBefore(this.dateSelector);
  ...
  dateToString: function(date) {
	...
	if(thisDay< 10)
		thisDay = "0"+thisDay;
    return thisDay + "/" + this.short_month_names[date.getMonth()] + "/" + date.getFullYear();
  },
